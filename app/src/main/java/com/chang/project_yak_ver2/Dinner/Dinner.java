package com.chang.project_yak_ver2.Dinner;
...
public class Dinner extends AppCompatActivity implements Serializable {
    public static final String DailyAlarm = "dDailyAlarm";
    public static final String NextNotifyTime = "dNextNotifyTime";
    public static final String sharderPending = "dPending";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RecyclerView rvList = findViewById(R.id.rv_dinner);
        postAdapter adapter = new postAdapter(this, drugList,3);
        ...
        final TimePicker Picker = findViewById(R.id.tp_dinner);
        ...
        long millis = sharedPref.getLong(
                NextNotifyTime, defaultDinnerTime.getTimeInMillis());
        ...
        Button OnButton = (Button) findViewById(R.id.btn_dinnerOn);
        ...
        Button OffButton = (Button) findViewById(R.id.btn_dinnerOff);
    ...
    private void diaryNotification(Calendar calendar) {
        ComponentName receiver = new ComponentName(this, DinnerBoot.class);
        PackageManager pm = this.getPackageManager();
        Intent alarmIntent = new Intent(this, DinnerReceiver.class);
        pendingIntent = PendingIntent.getBroadcast(this, 2349, alarmIntent, PendingIntent.FLAG_UPDATE_CURRENT);
    ...
    private void CalcelAlarm() {
        if(IsAlarmExist){
            ...
            PackageManager pm = this.getPackageManager();
            Intent alarmIntent = new Intent(this, DinnerReceiver.class);
            pendingIntent = PendingIntent.getBroadcast(this, 2349, alarmIntent, 0);
            ...
            pm.setComponentEnabledSetting(receiver,
                    ...
                    PackageManager.DONT_KILL_APP);
            Toast.makeText(getApplicationContext(), "저녁 알람이 취소되었습니다!", Toast.LENGTH_SHORT).show();
        }
        else {
