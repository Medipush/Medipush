...
public class Morning extends AppCompatActivity implements Serializable {
    public static final String DailyAlarm = "mDailyAlarm";
    public static final String NextNotifyTime = "mNextNotifyTime";
    public static final String sharderPending = "mPending";
    private AlarmManager alarmManager = null;
    private PendingIntent pendingIntent = null;
    boolean IsAlarmExist;
    private int hour, minute;
    private static  ArrayList<DrugModel> drugList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RecyclerView rvList = findViewById(R.id.rv_morning);

        postAdapter adapter = new postAdapter(this, drugList,1);
        ...
        final TimePicker Picker = findViewById(R.id.tp_morning);
        ...
        long millis = sharedPref.getLong(
                NextNotifyTime, defaultMorningTime.getTimeInMillis());
        ...
        Button OnButton = (Button) findViewById(R.id.btn_morningOn);
        ...
        Button OffButton = (Button) findViewById(R.id.btn_morningOff);
    ...
    private void CalcelAlarm() {
        if(IsAlarmExist){
            ...
            ComponentName receiver = new ComponentName(this, MorningBoot.class);
            alarmManager = (AlarmManager) getSystemService(Context.ALARM_SERVICE);
            PackageManager pm = this.getPackageManager();
            Intent alarmIntent = new Intent(this, MorningReceiver.class);
            pendingIntent = PendingIntent.getBroadcast(this, 2346, alarmIntent, 0);
                ...
                Toast.makeText(getApplicationContext(), "아침 알람이 취소되었습니다!", Toast.LENGTH_SHORT).show();
            }
            else {
    ...
    private void diaryNotification(Calendar calendar) {
        ...
        PackageManager pm = this.getPackageManager();
        Intent alarmIntent = new Intent(this, MorningReceiver.class);
        pendingIntent = PendingIntent.getBroadcast(this, 2346, alarmIntent, PendingIntent.FLAG_UPDATE_CURRENT);
        alarmManager = (AlarmManager) getSystemService(Context.ALARM_SERVICE);
